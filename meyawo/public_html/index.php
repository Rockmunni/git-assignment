    ...
    <header id="home" class="header">
        ...
        <div class="header-content container">
            <h1 class="header-title">
                ...
                <span class="down">I am rock  </span>
            </h1>
 ...
 ?>
    ...
    while ($data = mysqli_fetch_assoc($run)) {
      ?>
        ...
        <img src="<?php echo $data['image']; ?>" width="100%" height="auto">
            ...
            <form method="POST" class="contact-form col-md-10 col-lg-8 m-auto">
                <div class="form-row">
                    ...
                    <div class="form-group col-sm-12">
                        <textarea  id="comment" rows="6"   class="form-control" placeholder="Write Something" name="text"></textarea>
                    </div>
                    <div class="form-group col-sm-12 mt-3">
                        <input type="submit" value="" class="btn btn-outline-primary rounded" name="go">                  
                    </div>
                </div>  
            </form><!-- end of contact form -->
        </div><!-- end of container -->
    </section><!-- end of contact section -->
    <h1>change blog picture</h1>
...
if (isset($_POST['done'])) {
  ...
  $q1 =  "INSERT INTO `picture`( `image`) VALUES ('$des')";
  print_r($q1);
  mysqli_query($con,$q1);
...
$e= $_POST['email'];
$t= $_POST['text'];
$q =  "INSERT INTO `hub`( `name`, `email`, `text`) VALUES ('$n','$e','$t')";
print_r($q);
mysqli_query($con,$q);
}
